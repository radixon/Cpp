...
***************************************************************/
	...
	// 6.1 Function Basics
	double interest_rate(double credit_score)
	{
		double apr;
